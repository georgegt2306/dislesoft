    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'url'  => 'actividades',
            'icon' => 'fas fa-thumbtack',
            'can'  => ['unidad1', 'unidad2', 'unidad3', 'unidad4'],
            'submenu' => [
                [
                    'text' => 'Unidad #1',
                    ...
                    'submenu' => [
                        [
                            'text' => 'Ejercicio 1 - Novela de aventuras',
                            'icon' => 'fas fa-edit',
                            'url'  => 'u1ejercicio1',
                        ],
                        [
                            'text' => 'Ejercicio 2 - Estructura de la novela',
                            'icon' => 'fas fa-edit',
                            'url'  => 'u1ejercicio2',
                        ],
                        [
                            'text' => 'Ejercicio 3 - Elementos que componen la novela',
                            'icon' => 'fas fa-edit',
                            'url'  => 'u1ejercicio3',
                        ],
                        [
                            'text' => 'Ejercicio 4 - La entrevista',
                            'icon' => 'fas fa-edit',
                            'url'  => 'u1ejercicio4',
                        ],
                        [
                            'text' => 'Ejercicio 5 - La entrevista',
                            'icon' => 'fas fa-edit',
                            'url'  => 'u1ejercicio5',
                        ],
                        [
                            'text' => 'Ejercicio 6 - Estructura de la entrevista',
                            'icon' => 'fas fa-edit',
                            'url'  => 'u1ejercicio6',
                        ],
                        [
                            'text' => 'Ejercicio 7 - Las preguntas de la entrevista',
                            'icon' => 'fas fa-edit',
                            'url'  => 'u1ejercicio7',
                        ],
                        [
                            'text' => 'Ejercicio 8 - Uso de los pronombres y adverbios interrogativos',
                            'icon' => 'fas fa-edit',
                            'url'  => 'u1ejercicio8',
                        ],
                        [
                            'text' => 'Ejercicio 9 - Modos y tiempos verbales',
                            'icon' => 'fas fa-edit',
                            'url'  => 'u1ejercicio9',
                        ],
                    ],
